      ...
      <div className="max-w-2xl mx-auto px-4 py-8 space-y-5">
        ...
        {estado === 'loading' && (
          <div className="text-center py-12">
            <div className="inline-block w-8 h-8 rounded-full border-4 border-gray-100 border-t-blue-800 animate-spin mb-3" />
            <p className="text-gray-400 text-sm">Buscando producto...</p>
          </div>
        )}
