...
export default function HomeClient({ productosLocales }: { productosLocales: any[] }) {
    ...
    <main className="min-h-screen bg-white">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            >
              ...
              <div className="flex gap-1.5 md:gap-2">
                <select
                  className="px-2 md:px-3 py-1.5 md:py-2 rounded-lg outline-none text-xs md:text-sm font-medium cursor-pointer bg-gray-50 hidden md:block"
                  style={{ color: '#1A237E' }}
      ...
      <div className="border-b" style={{ backgroundColor: '#FAFAFA', borderColor: '#E5E7EB' }}>
        <div className="max-w-5xl mx-auto px-4 py-2 md:py-3 flex flex-wrap gap-x-4 md:gap-x-6 gap-y-0.5 text-[10px] md:text-sm text-gray-500 font-medium">
          ...
          <span>📦 <strong className="text-gray-700">{productosLocales.length}</strong> productos</span>
